...
Commit messages are very short texts, where topic models like Latent Dirichlet Allocation (LDA) often struggle. Therefore, this thesis uses keyword frequency analysis as a lightweight alternative. The analysis is applied to commit messages associated with edits to presence conditions identified by DiffDetective and MyAnalysis. Each commit message is treated as a short document and represented using tokenization and normalization (e.g., removal of non-alphabetic characters). After filtering stopwords and very short tokens, term frequencies are computed, and the most frequent keywords provide an interpretable approximation of recurring themes related to variability changes. This is such as bug fixing, cleanup of conditional compilation directives or refactoring and reconfiguration edits to presence conditions.
